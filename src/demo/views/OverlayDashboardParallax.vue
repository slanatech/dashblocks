<template>
  <div>
    <div class="db-layers">
      <div class="rellax db-layer db-background-img" style="height: 700px;" data-rellax-speed="-3">
        <img src="../assets/images/poster_grand_tour.png" />
      </div>
      <div class="rellax db-layer" data-rellax-speed="1" style="top: 70px;">
    ...
    <div style="text-align: center;">
      <h2>Overlay Dashboards with Parallax</h2>
      <h3>There is no reason</h3>
      <h3>why</h3>
      <h2>Dashboards</h2>
      <h3>should be boring</h3>
      <a href="http://dashblocks.io"><h2>http://dashblocks.io</h2></a>
    </div>
  </div>
</template>
      ...
      dbspec2: {
        ...
        widgets: [
          ...
          },*/
          {
            ...
            height: 140,
            properties: {
              markup: '<div class="overlay-title">CONVERSIONS</div>'
            }
          },
          {
            id: 'wA',
