...
import dashSpec from '../dashboards/ChartJsShowcase.json';
    ...
    initialize: function() {
      ...
      let dataBubbleTwoSeries = {
        ...
        datasets: [
          ...
          {
            label: 'Data Two',
            data: [{ x: 30, y: 50, r: 50 }, { x: 60, y: 60, r: 60 }, { x: 80, y: 70, r: 70 }, { x: 100, y: 200, r: 10 }]
          }
        ]
      };
      ...
      let dataScatterTwoSeries = {
        ...
        datasets: [
          {
            label: 'Data One',
            data: [{ x: 10, y: 20 }, { x: 20, y: 20 }, { x: 30, y: 30 }, { x: 100, y: 200 }]
          },
          {
            label: 'Data Two',
            data: [{ x: 30, y: 50 }, { x: 60, y: 60 }, { x: 80, y: 70 }, { x: 100, y: 200 }]
          }
        ]
      };
